...
public class SearchResult<Goods> extends PageResult<Goods> {
    ...
    public SearchResult(Long total,int totalPage, List<Goods> item,List<Category> categories, List<Brand> brands){
        super(total,totalPage,item);
        this.categories = categories;
        this.brands = brands;
    }

    public SearchResult(Long total,int totalPage, List<Goods> item,List<Category> categories,
